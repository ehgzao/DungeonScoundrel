...
// Import game state
import { game } from './game-state.js?v=1.8.1';
import { GOLD } from '../config/game-constants.js?v=1.8.1';
import { shopDiscount, recordPurchase } from './game-economy.js?v=1.8.1';
