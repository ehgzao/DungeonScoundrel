/* ============================================
   ...
   NOTE: Silent logging functions (silentLog, silentWarn, silentError)
   and global error handlers are defined in index.html <head> to ensure
   they are available before any scripts load.
   ============================================ */

// Only show error overlay for critical errors in development
if (!window.isProduction) {
    window.addEventListener('error', function(e) {
        // Show user-friendly error instead of white screen (only in dev)
        if (!document.querySelector('.error-overlay') && document.body) {
