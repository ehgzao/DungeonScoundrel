...
const EVENTS = [
    ...
    { id: 'treasure', title: 'ðŸº Cursed Treasure', text: 'A golden chest glimmers before you... but dark energy surrounds it.',
        choices: [
    ...
    { id: 'witch', title: 'ðŸ§™ Mysterious Witch', text: 'An old witch offers her services: "I can upgrade your equipment... for a price."',
        choices: [
            ...
            { text: 'ðŸƒ Decline', effect: () => { showMessage('"Your loss, scoundrel!"', 'info'); }}
        ]},
    ...
    { id: 'dragon', title: 'ðŸ‰ Sleeping Dragon', text: 'A dragon sleeps atop a massive hoard of gold. Do you dare...?',
        choices: [
            ...
            { text: 'ðŸƒ Run away', effect: () => { showMessage('Discretion is the better part of valor.', 'info'); }}
        ]},
    ...
    { id: 'altar', title: 'ðŸ•¯ï¸ Sacrificial Altar', text: 'An ancient altar radiates dark power. "Offer something... gain something greater."',
        choices: [
            ...
            { text: 'ðŸƒ Flee', effect: () => { showMessage('You back away slowly.', 'info'); }}
        ]},
