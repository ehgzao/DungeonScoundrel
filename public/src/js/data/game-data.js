...
const RELICS = [
    ...
    { id: 'bandage', name: '🩹 Bandage', description: 'Heal 0.5 HP per room cleared (adds up between rooms)', rarity: 'common', effect: 'tinyRegen' },
    ...
    { id: 'herb', name: '🌱 Herb', description: 'Potions usable twice per room', rarity: 'common', effect: 'doublePot' },
    ...
    { id: 'bell', name: '🔔 Bell', description: '+2 gold per room cleared; gold visible on cards', rarity: 'common', effect: 'goldSight' },
    ...
    { id: 'clover', name: '🍀 Four Leaf Clover', description: 'Avoid can be used 2x in row', rarity: 'common', effect: 'doubleAvoid' },
    ...
    { id: 'boots', name: '👟 Speed Boots', description: 'Draw 1 extra card in every room', rarity: 'uncommon', effect: 'extraDraw' },
    ...
    { id: 'master_smith', name: '🔨 Master Smith', description: '+1 weapon damage on equip; repairs weapon at end of each room', rarity: 'rare', effect: 'auto_repair' },
