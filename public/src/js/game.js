...
import {
    ...
    COMBAT,
    LUCKY_DRAW
} from './config/game-constants.js?v=1.7.5';
...
import {
    ...
    seedRunRng,
    runRand
} from './modules/game-state.js?v=1.7.5';
...
import {
    ...
    showEventModal,
    closeEventWrapper
} from './modules/game-events.js?v=1.7.5';
...
import {
    ...
    openShop,
    closeShop
} from './modules/game-shop.js?v=1.7.5';
...
import {
    ...
    updateRelicsDisplay,
    getRelicBonus
} from './modules/game-relics.js?v=1.7.5';
...
import {
    ...
    startGameWithClass,
    getPassiveIcons
} from './modules/game-classes.js?v=1.7.5';

// Import game sounds module
import { playSound } from './modules/game-sounds.js?v=1.7.5';
...
import { 
    ...
    shuffleDeck, 
    balanceEasyModeDeck 
} from './modules/game-deck.js?v=1.7.5';
...
import {
    ...
    undoLastMove,
    handleCardClick
} from './modules/game-combat.js?v=1.7.5';
